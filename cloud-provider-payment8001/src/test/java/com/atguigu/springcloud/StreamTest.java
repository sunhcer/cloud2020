...
//                .collect(Collectors.toMap((UUID::randomUUID)::toString,Payment::getId));
    ...
    @Test
    public void test() {
        Payment p1 = new Payment(1L, BigDecimal.ONE, BigDecimal.ONE, BigDecimal.ONE, BigDecimal.ONE, BigDecimal.ONE, BigDecimal.ONE, BigDecimal.ONE);
        Payment p2 = new Payment(1L, BigDecimal.ONE, BigDecimal.ONE, BigDecimal.ONE, BigDecimal.ONE, BigDecimal.ONE, BigDecimal.ONE, BigDecimal.ONE);
        Payment p3 = new Payment(1L, BigDecimal.ONE, BigDecimal.ONE, BigDecimal.ONE, BigDecimal.ONE, BigDecimal.ONE, BigDecimal.ONE, BigDecimal.ONE);
        Payment p4 = new Payment(1L, BigDecimal.ONE, BigDecimal.ONE, BigDecimal.ONE, BigDecimal.ONE, BigDecimal.ONE, BigDecimal.ONE, BigDecimal.ONE);
        Payment p5 = new Payment(1L, BigDecimal.ONE, BigDecimal.ONE, BigDecimal.ONE, BigDecimal.ONE, BigDecimal.ONE, BigDecimal.ONE, BigDecimal.ONE);

        Stream.of(p1, p2, p3, p4, p5).forEach(payment -> {
            payment.setCount2(Stream.of(payment.getAmount(), payment.getAmount1(), payment.getAmount2(), payment.getAmount3()).reduce(BigDecimal::multiply).get());
            payment.setCount3(Stream.of(payment.getAmount(), payment.getAmount1(), payment.getAmount2(), payment.getAmount3()).reduce(BigDecimal::divide).get());
