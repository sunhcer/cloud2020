...
//        Arrays.stream(objects).forEach(System.out::println);
    ...
    @Test
    public void testTo() {
        Set<String> collect = Stream.of("a" , "b" , "a").collect(Collectors.toSet());
    ...
    public void testJoin() {
        ...
        String collect = list.stream().collect(Collectors.joining("||" , "===start===" , "===end==="));
        System.out.println(collect);
    }

    @Test
    public void sunmmaringInt() {
    ...
    public void toMap(){
        Payment payment1 = new Payment(1L, "序列号1" , 10L);
        Payment payment2 = new Payment(1L, "序列号2" , 10L);
        Payment payment3 = new Payment(2L, "序列号3" , 10L);
        Payment payment4 = new Payment(5L, "序列号4" , 10L);
        Payment payment5 = new Payment(12L, "序列号5" , 10L);
        List<Payment> payments = Arrays.asList(payment1, payment2, payment3, payment4, payment5);

        Map<Long, String> collect = payments.stream()
                .collect(Collectors.toMap(Payment::getId, Payment::getSerial, (oldValue,newValue)->oldValue));
    ...
    public void groupingBy(){
        Payment payment1 = new Payment(1L, "序列号1" , 10L);
        Payment payment2 = new Payment(45L, "序列号1" , 10L);
        Payment payment3 = new Payment(2L, "序列号1" , 10L);
        Payment payment4 = new Payment(5L, "序列号2" , 10L);
        Payment payment5 = new Payment(12L, "序列号2" , 10L);
        List<Payment> payments = Arrays.asList(payment1, payment2, payment3, payment4, payment5);

        Map<String, List<Payment>> collect = payments.stream()
                .collect(Collectors.groupingBy(Payment::getSerial));
    ...
    public void partitioningBy(){
        Payment payment1 = new Payment(1L, "序列号1" , 10L);
        Payment payment2 = new Payment(45L, "序列号1" , 9L);
        Payment payment3 = new Payment(2L, "序列号1" , 10L);
        Payment payment4 = new Payment(5L, "序列号2" , 2L);
        Payment payment5 = new Payment(12L, "序列号2" , 11L);
        List<Payment> payments = Arrays.asList(payment1, payment2, payment3, payment4, payment5);

        Map<Boolean, List<Payment>> collect = payments.stream()
                .collect(Collectors.partitioningBy(source->source.getAmount()<10L));
